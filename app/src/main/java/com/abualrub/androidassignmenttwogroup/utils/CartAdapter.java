...
// ************************************** //
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> implements ITags {

    private ArrayList<Item> items;
    private ArrayList<Item> itemsCopy;
    private FragmentActivity fragmentActivity;

    public CartAdapter(Item[] items, FragmentActivity fragmentActivity) {
